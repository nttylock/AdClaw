...
def chats_group() -> None:
    ...
    \b
    Common examples:
      adclaw chats list                    # List all chats
      adclaw chats list --user-id alice    # Filter by user
      adclaw chats get <chat_id>           # View details
      adclaw chats create --session-id s1 --user-id u1
      adclaw chats delete <chat_id>        # Delete a chat
    """
...
def list_chats(
    ...
    Examples:
      adclaw chats list
      adclaw chats list --user-id alice
      adclaw chats list --channel discord
      adclaw chats list --user-id alice --channel discord
    """
...
def get_chat(
    ...
    \b
    CHAT_ID  Chat UUID, obtainable via `adclaw chats list`.
...
def create_chat(
    ...
    Inline creation examples:
      adclaw chats create --session-id "discord:alice" \\
...
def update_chat(
    ...
    \b
    Examples:
      adclaw chats update <chat_id> --name "Renamed Chat"
    """
    base_url = _base_url(ctx, base_url)
...
def delete_chat(
    ...
    \b
    Examples:
      adclaw chats delete 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = _base_url(ctx, base_url)
    with client(base_url) as c:
